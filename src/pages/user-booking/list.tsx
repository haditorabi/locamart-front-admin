import { USERBOOKING_DELETE_QUERY, USERBOOKING_LIST_QUERY } from "./queries";
...
export const UserBookingList: React.FC = () => {
          ...
          return (
            <HStack>
              ...
              <DeleteButton
                ...
                size="sm"
                recordItemId={getValue() as string}
                meta={{ gqlMutation: USERBOOKING_DELETE_QUERY }}
              />
            </HStack>
          );
        },
  ...
  const {
    ...
    refineCoreProps: {
      ...
      meta: {
        gqlQuery: USERBOOKING_LIST_QUERY,
      },
    },
  });

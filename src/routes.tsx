...
export const AppRoutes = (
  <Routes>
    ...
    >
      ...
      {/* <Route path="/DealRedumption">
        <Route index element={<Page.DealRedumptionList />} />
        <Route path="show/:id" element={<Page.DealRedumptionShow />} />
        <Route path="edit/:id" element={<Page.DealRedumptionEdit />} />
        <Route path="create" element={<Page.DealRedumptionCreate />} />
      </Route> */}
      {/* <Route path="/Event">
      ...
      {/* <Route path="/PaymentCategroy">
        <Route index element={<Page.PaymentCategroyList />} />
        <Route path="show/:id" element={<Page.PaymentCategroyShow />} />
        <Route path="edit/:id" element={<Page.PaymentCategroyEdit />} />
        <Route path="create" element={<Page.PaymentCategroyCreate />} />
      </Route> */}
      {/* <Route path="/Province">
